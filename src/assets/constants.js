import a from "./SliderImages/1.jpg";
import b from "./SliderImages/2.jpg";
import c from "./SliderImages/3.jpg";
import d from "./SliderImages/4.jpg";
import e from "./SliderImages/5.jpg";
import f from "./SliderImages/6.jpg";
import g from "./SliderImages/7.jpg";
import h from "./SliderImages/8.jpg";
...
export const images = [
...

  {
    ...
    title: "Buddy Daddies",
    url: d,
    desc: "Two professional contract criminals are up for their biggest mission yet: taking care of a child! ",
  },
...

  {
    ...
    url: g,
    desc: `Matsuri Kazamaki and Suzu Kanade are childhood friends, bonded by their shared ability to see ayakashi—youkai. However, in high school, their relationship deteriorates. As Suzu's one-sided feelings are growing, so is the difference in their ayakashi views: Matsuri considers all ayakashi a threat to his friend, while Suzu is an ayakashi medium—someone who exudes a significant amount of life force compared to the average human—and loves them all despite the risk. When the two stumble upon a talking white cat named Shirogane, they are unaware that it is a four-hundred-year-old ayakashi. Matsuri swoops in to try and save her by sealing Shirogane's powers, the ayakashi uses a jutsu to turn him into a girl instead! Matsuri vows to protect Suzu from further harm as her best friend, but he must learn how to act like a girl until his grandfather—a famous wind jutsu exorcist ninja—can undo the jutsu.`,
  },
